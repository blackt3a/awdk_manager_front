<template>
  <div>
    ...
    <el-menu :default-active="this.$route.path" mode="horizontal" :router="true" background-color="#323232" text-color="#fff" 
active-text-color="#2194EC">
      ...
      <el-menu-item index="" >zh-CN</el-menu-item>
      <el-menu-item index="" >en-US</el-menu-item>
    </el-sub-menu> 
      </el-menu-item>
...
export default {
  ...
  methods: {
    setLanguage() {
      this.$i18n.locale = this.base.Language || 'zh-CN'; // 设置默认值
    },
